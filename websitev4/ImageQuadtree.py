...
class Quadtree:
    ...
    def subdivide(self,image,x,y):
        ...
        new_images = []
        new_images.append([image.crop((w/2, 0,w,h/2)),x+w/2, y])
        new_images.append([image.crop((0, 0, w/2, h/2)),x,y])
        new_images.append([image.crop((w/2, h/2, w, h)),x+w/2, y+h/2])
        new_images.append([image.crop((0, h/2, w/2,h)),x,y+h/2])
